...
export default function App() {
  ...
  // Wake-up ping: hit backend /health when the app loads so sleeping free-tier backends wake up
  useEffect(() => {
    fetch(`${process.env.REACT_APP_API_URL ||
      'https://resume-extractor-backend-ockg.onrender.com'}/health`)
      .catch(() => {})
  }, [])
      ...
      <section id="features">
        ...
        <div className="features-grid">
          <div className="glass-panel feature-card">
            ...
            <p style={{ color: "var(--text-dim)", lineHeight: 1.6 }}>Process hundreds of resumes in parallel using advanced asynchronous worker queues. Get results in milliseconds, not minutes.</[...]
          </div>
          <div className="glass-panel feature-card">
